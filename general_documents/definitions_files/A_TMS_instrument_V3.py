...
def TMS_instrument_output(Tsky,t_load_r):
    ...
    print(np.mean(Un1),np.mean(Un2),np.mean(Un3),np.mean(Un4),np.mean(U))
    print(np.mean(U),np.mean(U1),np.mean(U2),np.mean(U3),np.mean(U4))
    ...
    axs[1].plot(xx1, np.abs(U), label=r'$\rm Nominal = %.3f$' % ((np.mean(U))), color='k')
    axs[1].plot(xx1, np.abs(U1), label=r'$\rm N1 = %.3f$' % ((np.mean(U1))), color=colors[0])
    axs[1].plot(xx1, np.abs(U2), label=r'$\rm N2 = %.3f$' % ((np.mean(U2))), color=colors[1])
    axs[1].plot(xx1, np.abs(U3), label=r'$\rm N3 = %.3f$' % ((np.mean(U3))), color=colors[2])
    axs[1].plot(xx1, np.abs(U4), label=r'$\rm N4 = %.3f$' % ((np.mean(U4))), color=colors[3])
    ...
    #plt.savefig('/home/aarriero/Documents/Angela_cmb/four_year/cap2_TOD_TMS/plots_paper/B_Gain_Noise_diff_3.pdf')
    #"""""
