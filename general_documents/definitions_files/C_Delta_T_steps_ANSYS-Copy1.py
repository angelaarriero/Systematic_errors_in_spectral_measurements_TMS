...
def Weights_subBands(array1_tiempo,freq_spec,total_BEM_atmos_cmb,total_I1_BEM_atmos_cmb,total_I2_BEM_atmos_cmb,T_sky_bet_total,T_load_bet_total):
    ...
    return sub_band_def, band_pass_prom_t,index_band_pass,band_pass_prom_t_I1,band_pass_prom_t_I2,band_pass_prom_t_betasky,band_pass_prom_t_betaload
...
def noise_instrument(array1_tiempo,freq_spec,band_pass_prom_t,band_pass_prom_t_I1,band_pass_prom_t_I2,ideal,f_knee,alpha):
    ###############################################################################################
    ########################## Definitions #################################
